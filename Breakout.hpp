...
bool mainBreakout(vector<Brick> & bricks)// returns true if player clears section, false if they are defeated. Program ends upon returning false.
{
    ...
    bricks = {
        ...
        Brick({5, 425, 190, 50}, WHITE, 1500, 700), Brick({205, 425, 190, 50}, WHITE, 1500, 700), Brick({405, 425, 190, 50}, WHITE, 1500, 700), Brick({605, 425, 190, 50}, WHITE, 1500, 700), Brick({805, 425, 190, 50}, WHITE, 1500, 700), 
        Brick({5, 485, 240, 50}, WHITE, 1500, 700), Brick({255, 485, 240, 50}, WHITE, 1500, 700), Brick({505, 485, 240, 50}, WHITE, 1500, 700), Brick({755, 485, 240, 50}, WHITE, 1500, 700), 
